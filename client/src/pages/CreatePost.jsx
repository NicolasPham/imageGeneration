  ...
  return (
    <section className="max-w-7xl mx-auto">
       <div>
        ...
        <p className='mt-2 text-[#666e75] text-[16px] max-w[500px]'>Create imaginative and visually stunning images though DALL-E AI and share them with the community</p>
      </div>
      ...
      <div className='mt-10'>
        <p className='mt-2 text-[#666e75] text-[14px]'>You can click the button below to share your image to the community</p>
        <button
          type="submit"
